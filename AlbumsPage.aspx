...
<body>
	<form id="form1" runat="server">
		...
		<asp:Panel ID="AddAlbumPanel" runat="server">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<asp:Label ID="TitleValidationLabel" runat="server" Font-Bold="True" ForeColor="Red" Text="The length of the title may not be null or more than 100" Visible="False"></asp:Label>
			<br />
			<br />
			...
			&nbsp;
			<asp:Label ID="GenresValidationLabel" runat="server" Font-Bold="True" ForeColor="Red" Text="The length of the genres may not be null or more than 50" Visible="False"></asp:Label>
			<br />
			<br />
			...
			&nbsp;s&nbsp;&nbsp;
			<asp:Label ID="LengthValidationLabel" runat="server" Font-Bold="True" ForeColor="Red" Text="The length of the length may not be null or more than 15" Visible="False"></asp:Label>
			<br />
			<br />
